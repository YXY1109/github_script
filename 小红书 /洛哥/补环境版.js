...
navigator = {
    ...
    clearAppBadge: function () {
        console.log("clearAppBadge", arguments)
    },
    getBattery: function () {
        console.log("getBattery", arguments)
    },
    getUserMedia: function () {
        console.log("getUserMedia", arguments)
    },
